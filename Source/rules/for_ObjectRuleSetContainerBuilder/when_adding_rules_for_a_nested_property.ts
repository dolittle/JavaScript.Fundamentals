...
describe('when adding rules for a nested property', () => {
    let given:an_object_with_nested_properties = new an_object_with_nested_properties();

    let builder = given.builder.rulesFor(_ => _.secondLevel.thirdLevel.value);
    let propertyDescriptor = (<PropertyRuleSetBuilder>builder).propertyDescriptor;
