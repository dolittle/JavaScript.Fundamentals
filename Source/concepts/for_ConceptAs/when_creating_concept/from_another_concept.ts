...
describe('when creating concept as number', () => {
    const value = 2;
    const base_concept = new number_concept(value);
    const concept = ConceptAs.from(base_concept, 'number_concept');
    ...
    it('should equal base concept', () => concept.equals(base_concept).should.be.true);
